...
storiesOf("⚠️Legacy/Publishing/Sections/Embed", module).add("Embed", () => {
  return (
    <div style={{ width: "100%" }}>
...
storiesOf("⚠️Legacy/Publishing/Sections/Social Embed", module)
  .add("Twitter", () => {
    return (
      <Fragment>
        <div style={{ width: "100%" }}>
...
storiesOf("⚠️Legacy/Publishing/Sections/Video", module)
  .add("Youtube", () => {
    return (
