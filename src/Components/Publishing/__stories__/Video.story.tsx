...
storiesOf("⚠️Legacy/Publishing/Video/Player", module).add("Player", () => {
  return (
...
storiesOf("⚠️Legacy/Publishing/Video/Cover", module)
  .add("Cover", () => {
...
storiesOf("⚠️Legacy/Publishing/Video/About", module)
  .add("About", () => {
