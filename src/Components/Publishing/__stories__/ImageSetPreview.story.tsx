...
storiesOf("⚠️Legacy/Publishing/Sections/Image Set/Classic", module).add(
  "Preview",
  () => {
...
storiesOf("⚠️Legacy/Publishing/Sections/Image Set/Editorial/Full", module)
  .add("Full", () => {
    return (
      <FullScreenProvider>
...
storiesOf("⚠️Legacy/Publishing/Sections/Image Set/Editorial/Mini", module)
  .add("Mini", () => {
    return (
      <FullScreenProvider>
        <div style={{ maxWidth: 680, width: "100%" }}>
