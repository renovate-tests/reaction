...
storiesOf("⚠️Legacy/Publishing/Header/Classic", module)
  .add("Classic", () => {
    return (
...
storiesOf("⚠️Legacy/Publishing/Header/Standard", module)
  .add("Standard", () => {
    return (
      <div style={{ width: "100%", height: "400px", position: "relative" }}>
...
storiesOf("⚠️Legacy/Publishing/Header/Feature/Basic", module)
  .add("Basic", () => {
...
storiesOf("⚠️Legacy/Publishing/Header/Feature/Text", module)
  .add("With Image", () => {
...
storiesOf("⚠️Legacy/Publishing/Header/Feature/Split", module)
  .add("With Image", () => {
    const article = _.extend({}, FeatureArticle, {
...
storiesOf("⚠️Legacy/Publishing/Header/Feature/Fullscreen", module)
  .add("With Image", () => {
    const article = _.extend({}, FeatureArticle, {
