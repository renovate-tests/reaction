...
storiesOf("⚠️Legacy/Components/Authentication/Desktop", module)
...
storiesOf("⚠️Legacy/Components/Authentication/Mobile", module)
  .add("Login", () => (
    <MobileContainer>
      <FormSwitcher
...
storiesOf("⚠️Legacy/Components/Authentication/Common Elements", module)
  .add("Footer - Signup", () => (
    <div>
      <Footer mode="signup" />
      <br />
